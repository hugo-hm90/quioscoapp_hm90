...
const Pedido = ({producto}) => {
    ...
    return (
        ...
        <div className="shadow p-5 mb-3 flex flex-col md:flex-row gap-10 items-center">
            ...
            <div>
                <button className="flex gap-2 px-5 py-2 justify-center text-white rounded-md font-bold shadow:md uppercase w-full text-center button raise" 
                    type="button"
                ...
                <button className="button flex gap-2 px-5 py-2 justify-center text-white rounded-md font-bold shadow:md uppercase w-full mt-5 raisered {
" 
                    type="button"
